...
var JanusPlugin = /** @class */ (function () {
                ...
                return [
                    ...
                    new Promise(function (resolve, reject) {
                        functionCall.apply(
                            void 0,
                            __spreadArray(
                                __spreadArray([], parameters, false),
                                [
                                    function (value) {
                                        resolve(value)
                                    },
    ...
    JanusPlugin.prototype.handleRecordingSetup = function (controllers) {
        ...
        this.onMessage.subscribe(function (_a) {
            ...
            var result =
                message === null || message === void 0 ? void 0 : message.result
            if (
            ...
            if (
                ...
                if (
                    ((_b = _this.mediaRecorder) === null || _b === void 0
                        ? void 0
                        : _b.state) !== 'inactive'
                )
                    (_c = _this.mediaRecorder) === null || _c === void 0
                        ? void 0
                        : _c.stop()
            }
        })
    ...
    JanusPlugin.prototype.handleStatsHook = function (
        plugin,
        controllers,
        mediaStreamTrack
    ) {
                ...
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0:
                            ...
                            return [
                                4 /*yield*/,
                                plugin.webrtcStuff.pc.getStats(),
                            ]
                        case 1:
                            reports = _a.sent()
