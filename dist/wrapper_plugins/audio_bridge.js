    ...
    JanusAudioBridgePlugin.prototype.joinRoom = function (room_1) {
        return __awaiter(this, arguments, void 0, function (room, _a) {
            ...
            var _b = _a === void 0 ? {} : _a,
                ...
                muted = _b.muted,
                codec = _b.codec,
                preBuffer = _b.preBuffer,
                bitrate = _b.bitrate,
                quality = _b.quality,
                expectedLoss = _b.expectedLoss,
                volume = _b.volume,
                spatialPosition = _b.spatialPosition,
                secret = _b.secret,
                audioLevelAverage = _b.audioLevelAverage,
                audioActivePackets = _b.audioActivePackets,
                record = _b.record,
