...
var JanusVideoRoomPlugin = /** @class */ (function (_super) {
    ...
    JanusVideoRoomPlugin.prototype.joinRoomAsPublisher = function (
        roomId,
        options
    ) {
        var payload = __assign(
            { request: 'join', room: roomId, ptype: 'publisher' },
            options
        )
    ...
    JanusVideoRoomPlugin.prototype.joinRoomAsSubscriber = function (
        room,
        options
    ) {
        return __awaiter(this, void 0, void 0, function () {
    ...
    JanusVideoRoomPlugin.prototype.startAsSubscriber = function (answer) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                ...
                return [
                    2 /*return*/,
                    this.send({ message: payload, jsep: answer }),
                ]
            })
        })
    }
    JanusVideoRoomPlugin.prototype.publishAsPublisher = function (
        offer,
        options
    ) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                ...
                return [
                    2 /*return*/,
                    this.send({ message: payload, jsep: offer }),
                ]
            })
        })
    }
    ...
    JanusVideoRoomPlugin.prototype.updateAsSubscriber = function (_a) {
        return __awaiter(this, arguments, void 0, function (_b) {
            var payload
            var subscribe = _b.subscribe,
                unsubscribe = _b.unsubscribe
